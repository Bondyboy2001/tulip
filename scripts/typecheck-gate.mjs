...
const CLEAN = [
  ...
  'src/cite.js',
  'src/codeblock.js',
  'src/completion-tooltip.js',
  'src/copilot-attachments.js',
  'src/copilot-chat.js',
  'src/copilot-context.js',
  'src/copilot-phases.js',
  'src/copilot-prefs.js',
  'src/copilot-render.js',
  'src/copilot-run.js',
  'src/copilot-store.js',
  'src/copilot-stream.js',
